...
def lambda_handler(event,context):
    ...
    s3objlanding = os.environ['OBJTARGET']
    ...
    try:
        ...
        for record in event['Records']:
            ...
            identity_guid = message_body['identity_guid']
            ...
            b = bytes(j.dumps(identity_framework), 'utf-8')
            f = io.BytesIO(b)
            s3_client.upload_fileobj(f, s3objlanding, s3key)    
